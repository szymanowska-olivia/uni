...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState05 : (('s, _menhir_box_main) _menhir_cell1_INCR, _menhir_box_main) _menhir_state
    (** State 05.
        Stack shape : INCR.
        Start symbol: main. *)

  | MenhirState07 : (('s, _menhir_box_main) _menhir_cell1_DECR, _menhir_box_main) _menhir_state
    (** State 07.
        Stack shape : DECR.
        Start symbol: main. *)
...
and ('s, 'r) _menhir_cell1_base_expr = 
  | MenhirCell1_base_expr of 's * ('s, 'r) _menhir_state * (Ast.expr)
...
and ('s, 'r) _menhir_cell1_DECR = 
  | MenhirCell1_DECR of 's * ('s, 'r) _menhir_state
...
and ('s, 'r) _menhir_cell1_INCR = 
  | MenhirCell1_INCR of 's * ('s, 'r) _menhir_state
...
include struct
  ...
  and _menhir_run_16 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | INCR ->
          let _menhir_stack = MenhirCell1_base_expr (_menhir_stack, _menhir_s, _v) in
  ...
  and _menhir_run_10 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_base_expr -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
      let _tok = _menhir_lexer _menhir_lexbuf in
      let MenhirCell1_base_expr (_menhir_stack, _menhir_s, x) = _menhir_stack in
      let _v = _menhir_action_03 x in
      _menhir_goto_base_expr _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_run_11 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_base_expr -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
      let _tok = _menhir_lexer _menhir_lexbuf in
      let MenhirCell1_base_expr (_menhir_stack, _menhir_s, x) = _menhir_stack in
  ...
  and _menhir_run_05 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      let _menhir_stack = MenhirCell1_INCR (_menhir_stack, _menhir_s) in
  ...
  and _menhir_run_07 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      let _menhir_stack = MenhirCell1_DECR (_menhir_stack, _menhir_s) in
  ...
  and _menhir_run_12 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_INCR as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | INCR ->
          let _menhir_stack = MenhirCell1_base_expr (_menhir_stack, _menhir_s, _v) in
      ...
      | DECR ->
          ...
          _menhir_run_11 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | COLON | DIV | EQ | GEQ | GT | LEQ | LT | MINUS | NEQ | OR | PLUS | RPAREN | TIMES ->
          let MenhirCell1_INCR (_menhir_stack, _menhir_s) = _menhir_stack in
          let x = _v in
  ...
  and _menhir_run_09 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_DECR as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | INCR ->
          let _menhir_stack = MenhirCell1_base_expr (_menhir_stack, _menhir_s, _v) in
      ...
      | DECR ->
          ...
          _menhir_run_11 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | COLON | DIV | EQ | GEQ | GT | LEQ | LT | MINUS | NEQ | OR | PLUS | RPAREN | TIMES ->
          let MenhirCell1_DECR (_menhir_stack, _menhir_s) = _menhir_stack in
          let x = _v in
